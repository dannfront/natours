...
exports.isLoggued = function _callee3(req, res, next) {
  var decoded, userAct;
    ...
    while (1) {
      switch (_context4.prev = _context4.next) {
        ...
        case 2:
          ...
          return _context4.abrupt("return", next(new appError('This email does not exist, please enter a valid email', 404)));
        ...
        case 21:
          return _context4.abrupt("return", new appError('Failed to send email', 500));
    ...
    while (1) {
      switch (_context5.prev = _context5.next) {
        ...
        case 3:
          ...
          return _context5.abrupt("return", next(new appError("token inavlid o expired", 404)));
    ...
    while (1) {
      switch (_context6.prev = _context6.next) {
        ...
        case 5:
          ...
          return _context6.abrupt("return", next(new appError('invalid password, please re-enter password', 403)));
