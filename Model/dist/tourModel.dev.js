...
var slugify = require('slugify'); //creamos un schema con moongose.Schema({}) (plantilla) para los tour


var tourSchema = new moongose.Schema({
  name: {
    type: String,
    ...
    minlength: [10, 'A tour name must have more or equal then 10 characters'] // validate: [validator.isAlpha, 'Tour name must only contain characters']
  ...
  guides: [// esto sera un arreglo que guardara o hara referencia en este caso sera la id
...
var Tour = moongose.model('Tour', tourSchema);
module.exports = Tour;