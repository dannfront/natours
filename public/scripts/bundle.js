...
},{}],"getLogin.js":[function(require,module,exports) {
"use strict";
...
function loggout() {
  return _loggout.apply(this, arguments);
}
function _loggout() {
  _loggout = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var res;
...
},{"./alerts.js":"alerts.js"}],"script.js":[function(require,module,exports) {
"use strict";
...
},{}],"updateMe.js":[function(require,module,exports) {
"use strict";
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } // import axios from "axios";
function updateMe(_x, _x2) {
  return _updateMe.apply(this, arguments);
}
function _updateMe() {
  _updateMe = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, email) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
...
function _updatePassword() {
  _updatePassword = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(passwordCurrent, password, passwordConfirm) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
...
if (formUserData) {
  document.querySelector(".form--update").addEventListener('submit', function (e) {
    ...
    var email = document.querySelector("#email").value;
    (0, _updateMe.updateMe)(name, email);
  });
}
console.log(formUserPassword);
if (formUserPassword) {
...
},{"./getLogin.js":"getLogin.js","./script.js":"script.js","./updateMe.js":"updateMe.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
